...
var img = [];
var display_timing = [100,200,300,400,500,600,700,800,900,1000]; // keyframe for appear images
var img_count = 0;
var orientation = [];
var ratio = [];
...
function draw()
{
  ...
  image(img[img_count], windowWidth/2, windowHeight/2, img[img_count].width/3, img[img_count].height/3);
...
// fare apparire la gallery solo dopo aver riconosciuto almeno un volto
// mettere la webcam in greyscale
// posizionare una maschera in modo che l'utente posizioni il suo volto all'interno di linee guida per facilitare il riconoscimento
// form per l'inserimento del nome dell'utente e pulsante "inizia"
// disattivare affectiva e la cam quando la gallery foto è finita
